...
- [ ] **AIOS-EXEC-03 Symphony-compatible Agent Runner** — mapear/adaptar Symphony como camada de execucao para WorkItems de desenvolvimento, com workspace isolado, status, retry e observability
